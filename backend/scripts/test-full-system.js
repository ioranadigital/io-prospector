...
try {
  const csvPath = 'E:\\Prospector-Data\\2026-05-04\\leads-test-2026-05-04T*.csv';
  const files = fs.readdirSync('E:\\Prospector-Data\\2026-05-04\\')
  ...
  const readCsvPath = `E:\\Prospector-Data\\2026-05-04\\${files[0]}`;
