...
# NOTE: Build is skipped - run 'npm run build' locally before deploying
# Building in Docker fails due to complex hooks, but works fine locally
# The .next/ directory from local build will be copied below
