...
export function ConfirmDialog({
  ...
  return (
    ...
    >
      <div
        className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-xl p-6 w-full max-w-md mx-4 shadow-2xl"
      ...
      >
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <button
            onClick={onConfirm}
            disabled={loading}
            className="px-4 py-2 bg-red-600 hover:bg-red-700 text-zinc-900 dark:text-white rounded-lg text-sm font-medium transition disabled:opacity-50"
          >
